        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TitelEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TitelAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameAn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameEr = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAr = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LocationEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LocationAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceDetailsID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Projects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Projects_ServiceDetails_ServiceDetailsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ServiceDetailsID",
                table: "Projects",
